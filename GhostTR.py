...
def Live_Track():
    ...
    print(f"\n {Wh}============= {Gr}LIVE LOCATION TRACKING {Wh}=============")
    print(f" {Wh}Target IP           :{Gr} {ip}")
    print(f" {Wh}Refresh Interval    :{Gr} {refresh_interval}s")
    print(f" {Wh}Press Ctrl+C to stop tracking")
    print(f" {Wh}=====================================================\n")
    ...
    try:
        ...
        if len(tracking_data) > 0:
            print(f" {Wh}First Location     :{Gr} {tracking_data[0]['city']}, {tracking_data[0]['country']}")
            print(f" {Wh}Last Location      :{Gr} {tracking_data[-1]['city']}, {tracking_data[-1]['country']}")
            print(f" {Wh}Tracking Started   :{Gr} {tracking_data[0]['time']}")
            print(f" {Wh}Tracking Ended     :{Gr} {tracking_data[-1]['time']}")
